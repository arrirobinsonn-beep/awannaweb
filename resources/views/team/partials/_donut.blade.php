{{-- ═══════════════════════════════════════════════════════════════
    PARTIAL: Doughnut porsi lead per CS (dipakai utk Running & Testing)
    Variabel: $chartData (array label/lead/paid/is_utama), $domId
════════════════════════════════════════════════════════════════ --}}
@if(empty($chartData))
...
@else
    ...
    <div style="display:flex;justify-content:center;flex-shrink:0;" class="cs-donut-pop">
        <svg id="{{ $domId }}" viewBox="0 0 220 220" width="184" height="184" role="img" aria-label="Diagram porsi lead per CS" data-ver="4">
