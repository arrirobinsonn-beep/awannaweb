...
<div class="clay-card" style="padding:0;overflow:hidden;">
  ...
  {{-- Header export per batch (dynamic via AJAX) ── --}}
  <div id="ord-export-header">
    @include('order._export_header', ['selectedBatch' => $selectedBatch, 'exportTemplates' => $exportTemplates, 'courierCounts' => $courierCounts, 'isCs' => $isCs])
  </div>
...
(function () {
  ...
  function fetchOrderTable() {
    ...
    .then(function(data) {
      ...
      var eh = document.getElementById('ord-export-header');
      if (eh && data.exportHeader !== undefined) eh.innerHTML = data.exportHeader;
    });
  }
