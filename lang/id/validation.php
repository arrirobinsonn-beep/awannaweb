...
return [
    ...
    'attributes' => [
        ...
        'today_lead' => 'Lead',
        'today_paid' => 'Paid',
        'decline_note' => 'Alasan penolakan',
        'va_number' => 'Nomor VA',
        'sisa_saldo_dilaporkan' => 'Sisa saldo',
        'nominal' => 'Nominal top up',
        'items' => 'Item whitelist',
        'items.*.whitelist_id' => 'Whitelist',
        'items.*.nominal' => 'Nominal top up',
        'items.*.item_id' => 'Item ID',
        'items.*.va_number' => 'Nomor VA',
        'items.*.sisa_saldo_dilaporkan' => 'Sisa saldo',
    ],
];
